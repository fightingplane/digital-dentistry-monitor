#!/usr/bin/env python3
"""
齿科数字化资讯 RSS 监控脚本（安全版本）
自动监控多个 RSS 源，过滤关键词，生成摘要，并通过 Telegram 发送通知
敏感信息从环境变量读取，不存储在配置文件中
"""
...
DEFAULT_CONFIG = {
    ...
    "keywords": [
        ...
        "口扫", "数字化牙科", "CAD/CAM", "3D打印牙科", "人工智能牙科"
    ],
    "rss_sources": [
        {
        ...
        {
            "name": "The Probe",
            "url": "https://www.the-probe.com/feed/",
            "enabled": True,
            "category": "uk_dental_media",
            "priority": "medium"
        },
        {
            "name": "Align Technology News",
            "url": "https://news.invisalign.com/feed/",
            "enabled": True,
        ...
        {
            "name": "exocad Blog",
            "url": "https://www.exocad.com/blog/feed/",
            "enabled": True,
        ...
        {
            "name": "中华口腔医学会",
            "url": "http://www.csa.org.cn/xwzx/zyxw/rss.xml",
            "enabled": True,
            "category": "chinese_professional",
            "priority": "high"
        },
        {
            "name": "今日口腔",
            "url": "https://www.kq88.com/rss.xml",
            "enabled": True,
            "category": "chinese_dental_media",
            "priority": "medium"
        }
    ]
}
...
def validate_telegram_config():
    ...
    if not TELEGRAM_BOT_TOKEN:
        ...
        print("请设置环境变量: export TELEGRAM_BOT_TOKEN='your_token_here'")
        return False
    
    if not TELEGRAM_CHAT_ID:
        print("❌ 错误: 未设置 TELEGRAM_CHAT_ID 环境变量")
        print("请设置环境变量: export TELEGRAM_CHAT_ID='your_chat_id_here'")
        return False
